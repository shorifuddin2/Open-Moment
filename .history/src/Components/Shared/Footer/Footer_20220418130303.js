...
const Footer = () => {
    const year = new Date()
    return (
        <footer className="text-center lg:text-left bg-gray-800">
            <div className="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
                <div className="mr-12 hidden lg:block text-white">
                    <span>Get connected with us on social networks:</span>
                </div>
                <div className="flex justify-center">
                    <a href="#!" className="mr-6 text-white bg-gray-800">
                    ...
                    <a href="#!" className="text-white bg-gray-800">
            ...
            <div className="text-center p-6 text-white bg-gray-800">
                <span>© {year.getFullYear()} Copyright: </span>
                <a className="text-gray-600 font-semibold" href="/">Sabbir Mahmud.</a>
            </div>
        </footer >
    );
};
